...
(Note: OpenGL rendering was specifically chosen because Direct3D 9 is broken in OW v2; This method written for compilation under Windows; on Linux, the steps are slightly different)
