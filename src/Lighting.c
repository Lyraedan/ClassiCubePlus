...
*--------------------------------------------------Infinite lighting-----------------------------------------------------*
*#########################################################################################################################*/
/* Infinite worlds have no whole-world heightmap, so all blocks are treated as
   fully lit by sunlight. */
static cc_bool InfiniteLighting_IsLit(int x, int y, int z) { return true; }
static cc_bool InfiniteLighting_IsLit_Fast(int x, int y, int z) { return true; }
static PackedCol InfiniteLighting_Color(int x, int y, int z) { return Env.SunCol; }
static PackedCol InfiniteLighting_Color_XSide(int x, int y, int z) { return Env.SunXSide; }
static PackedCol InfiniteLighting_Color_Sprite_Fast(int x, int y, int z) { return Env.SunCol; }
static PackedCol InfiniteLighting_Color_YMax_Fast(int x, int y, int z) { return Env.SunCol; }
static PackedCol InfiniteLighting_Color_YMin_Fast(int x, int y, int z) { return Env.SunYMin; }
static PackedCol InfiniteLighting_Color_XSide_Fast(int x, int y, int z) { return Env.SunXSide; }
static PackedCol InfiniteLighting_Color_ZSide_Fast(int x, int y, int z) { return Env.SunZSide; }
static void InfiniteLighting_OnBlockChanged(int x, int y, int z, BlockID oldBlock, BlockID newBlock) { }
static void InfiniteLighting_Refresh(void) { }
static void InfiniteLighting_LightHint(int startX, int startY, int startZ) { }
static void InfiniteLighting_FreeState(void) { }
static void InfiniteLighting_AllocState(void) { }

static void InfiniteLighting_SetActive(void) {
	Lighting.OnBlockChanged = InfiniteLighting_OnBlockChanged;
	Lighting.Refresh        = InfiniteLighting_Refresh;
	Lighting.IsLit          = InfiniteLighting_IsLit;
	Lighting.Color          = InfiniteLighting_Color;
	Lighting.Color_XSide    = InfiniteLighting_Color_XSide;

	Lighting.IsLit_Fast        = InfiniteLighting_IsLit_Fast;
	Lighting.Color_Sprite_Fast = InfiniteLighting_Color_Sprite_Fast;
	Lighting.Color_YMax_Fast   = InfiniteLighting_Color_YMax_Fast;
	Lighting.Color_YMin_Fast   = InfiniteLighting_Color_YMin_Fast;
	Lighting.Color_XSide_Fast  = InfiniteLighting_Color_XSide_Fast;
	Lighting.Color_ZSide_Fast  = InfiniteLighting_Color_ZSide_Fast;

	Lighting.FreeState  = InfiniteLighting_FreeState;
	Lighting.AllocState = InfiniteLighting_AllocState;
	Lighting.LightHint  = InfiniteLighting_LightHint;
}
...
static void OnNewMapLoaded(void) { Lighting_ApplyActive(); Lighting.AllocState(); }
